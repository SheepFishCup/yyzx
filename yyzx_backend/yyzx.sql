...
-- Records of backdown
-- ----------------------------
INSERT INTO `backdown` VALUES (1, '暂无', 0, 40, '2023-12-17', 0, '临时出院', 1, '1', NULL);
...
INSERT INTO `backdown` VALUES (4, '死亡', 1, 40, '2025-06-30', 1, '病死', 0, '2', '2025-06-29');
INSERT INTO `backdown` VALUES (5, NULL, 0, 42, '2026-03-02', 2, '测试1', 2, '1', '2026-03-02');
INSERT INTO `backdown` VALUES (6, '系统自动审批：超过 24 小时未人工处理', 0, 42, '2026-03-02', 2, '测试2', 1, '0', '2026-03-10');
...
CREATE TABLE `bed`  (
  ...
  `room_no` int(0) NOT NULL COMMENT '房间编号',
  `bed_status` int(0) NOT NULL COMMENT '房间状态 1：空闲  2：有人  3：外出',
...
CREATE TABLE `beddetails`  (
  ...
  `customer_id` bigint(0) NULL DEFAULT NULL COMMENT '顾客ID',
  `bed_id` int(0) NULL DEFAULT NULL COMMENT '床位ID',
  `is_deleted` int(0) NULL DEFAULT NULL COMMENT '逻辑删除标记（0：显示；1：隐藏）',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_beddetails_customer_deleted`(`customer_id`, `is_deleted`) USING BTREE
...
INSERT INTO `beddetails` VALUES (60, '2023-11-17', '2025-12-05', '606#2012-1', 40, 46, 0);
...
INSERT INTO `beddetails` VALUES (64, '2024-01-03', '2024-02-16', '606#1005-1', 41, 12, 1);
INSERT INTO `beddetails` VALUES (65, '2024-01-15', '2025-12-16', '606#1005-2', 32, 13, 1);
INSERT INTO `beddetails` VALUES (68, '2025-07-07', '2025-07-08', '606#1013-1', 42, 27, 1);
INSERT INTO `beddetails` VALUES (69, '2025-07-08', '2025-12-16', '606#1016-1', 42, 31, 1);
INSERT INTO `beddetails` VALUES (71, '2025-12-16', '2025-12-23', '606#1001-2', 32, 7, 0);
INSERT INTO `beddetails` VALUES (72, '2025-12-16', '2025-07-16', '606#1006-1', 42, 14, 0);
...
CREATE TABLE `customer`  (
  ...
  `customer_age` int(0) NOT NULL COMMENT '年龄',
  `customer_sex` int(0) NOT NULL COMMENT '性别  0：男  1：女',
  ...
  `bed_id` int(0) NOT NULL COMMENT '床号',
  ...
  `user_id` bigint(0) NULL DEFAULT NULL COMMENT '关联系统健康管家(护工)  无管家设置  -1',
  `level_id` int(0) NULL DEFAULT NULL COMMENT '护理等级',
  `family_member` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '家属',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `nurselevel_customer_fk`(`level_id`) USING BTREE,
  INDEX `user_customer_fk`(`user_id`) USING BTREE,
  INDEX `idx_customer_deleted`(`is_deleted`) USING BTREE
...
INSERT INTO `customer` VALUES (28, 0, '高廉武', 83, 0, '610404194103010017', '1002', '606', '2023-11-17', '2024-11-30', '13767675481', 9, '', NULL, '1941-03-01', NULL, NULL, 'A', '@/assets/tou.png', 5, 4, '高校蓝');
...
INSERT INTO `customer` VALUES (30, 0, '石秀英', 73, 1, '610422195102220029', '2018', '606', '2023-11-17', '2025-12-31', '13867541321', 52, '', NULL, '1951-02-22', NULL, NULL, 'O', '@/assets/tou.png', 5, 5, '石杰颖');
INSERT INTO `customer` VALUES (31, 0, '何风云', 62, 1, '610402196111166507', '2017', '606', '2023-11-17', '2025-11-29', '18765652312', 51, '', NULL, '1961-11-16', NULL, NULL, 'O', '@/assets/tou.png', 3, 5, '何方');
INSERT INTO `customer` VALUES (32, 0, '毛兰香', 73, 1, '61040419501227002x', '1001', '606', '2023-11-17', '2027-11-12', '15816164587', 7, '', NULL, '1950-12-27', NULL, NULL, 'O', '@/assets/tou.png', -1, NULL, '毛参');
...
INSERT INTO `customer` VALUES (34, 0, '刘海云', 64, 0, '510522196005042710', '1006', '606', '2023-11-17', '2025-01-30', '18798986545', 15, '', NULL, '1960-05-04', NULL, NULL, 'O', '@/assets/tou.png', 4, 1, '刘高');
...
INSERT INTO `customer` VALUES (37, 0, '陈泉', 68, 0, '61040219560313030x', '1012', '606', '2023-11-17', '2025-11-20', '18567546712', 26, '', NULL, '1956-03-13', NULL, NULL, 'O', '@/assets/tou.png', 4, 3, '陈荣光');
INSERT INTO `customer` VALUES (38, 0, '苗月兰', 67, 1, '622725195701081429', '2005', '606', '2023-11-17', '2025-11-29', '18367541987', 38, '', NULL, '1957-01-08', NULL, NULL, 'A', '@/assets/tou.png', 3, 6, '苗存义');
...
INSERT INTO `customer` VALUES (42, 0, '杨依儒', 21, 1, '330381200404122520', '1006', '606', '2025-07-05', '2025-07-16', '18324275991', 14, '', NULL, '2004-04-12', NULL, NULL, 'B', '@/assets/tou.png', 7, 4, '杨洁');
INSERT INTO `customer` VALUES (43, 0, 'yyr', 0, 1, '3303812004041225220', '1013', '606', '2025-07-16', '2025-07-31', '18324275991', 27, '', NULL, '2025-07-08', NULL, NULL, 'O', '@/assets/tou.png', -1, NULL, 'yyr');
...
CREATE TABLE `customernurseitem`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `item_id` int(0) NOT NULL COMMENT '护理项目编号',
  `customer_id` bigint(0) NOT NULL COMMENT '客户编号',
  `level_id` int(0) NULL DEFAULT NULL COMMENT '护理级别编号',
  `nurse_number` int(0) NOT NULL COMMENT '购买数量',
  `is_deleted` int(0) NULL DEFAULT NULL COMMENT '逻辑删除标记（0：显示；1：隐藏）',
  `buy_time` date NOT NULL COMMENT '服务购买日期',
  `maturity_time` date NOT NULL COMMENT '服务到期日',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_cni_customer_deleted`(`customer_id`, `is_deleted`) USING BTREE
...
-- ----------------------------
INSERT INTO `customernurseitem` VALUES (58, 1, 40, 2, 2, 0, '2023-10-17', '2024-01-17');
INSERT INTO `customernurseitem` VALUES (59, 2, 40, 2, 2, 0, '2023-10-17', '2023-11-16');
INSERT INTO `customernurseitem` VALUES (60, 3, 40, 2, 2, 0, '2023-10-17', '2024-01-17');
INSERT INTO `customernurseitem` VALUES (61, 4, 40, 2, 2, 0, '2023-10-17', '2023-11-28');
INSERT INTO `customernurseitem` VALUES (62, 1, 39, 3, 2, 0, '2023-10-17', '2024-01-17');
INSERT INTO `customernurseitem` VALUES (63, 2, 39, 3, 2, 0, '2023-10-17', '2024-01-17');
INSERT INTO `customernurseitem` VALUES (64, 3, 39, 3, 2, 0, '2023-10-17', '2024-01-17');
INSERT INTO `customernurseitem` VALUES (65, 5, 39, 3, 2, 1, '2023-10-17', '2024-01-17');
INSERT INTO `customernurseitem` VALUES (66, 6, 39, 3, 2, 1, '2023-10-17', '2024-01-17');
INSERT INTO `customernurseitem` VALUES (67, 1, 36, NULL, 2, 0, '2023-10-21', '2024-01-21');
INSERT INTO `customernurseitem` VALUES (68, 3, 36, NULL, 2, 0, '2023-10-21', '2024-01-21');
INSERT INTO `customernurseitem` VALUES (69, 4, 36, NULL, 2, 1, '2023-10-21', '2024-01-21');
INSERT INTO `customernurseitem` VALUES (70, 4, 36, NULL, 2, 0, '2023-10-21', '2024-01-21');
INSERT INTO `customernurseitem` VALUES (71, 20, 40, NULL, 2, 0, '2023-10-23', '2024-01-23');
INSERT INTO `customernurseitem` VALUES (72, 17, 40, NULL, 2, 0, '2023-10-23', '2024-01-23');
INSERT INTO `customernurseitem` VALUES (73, 10, 40, NULL, 2, 0, '2023-10-23', '2024-01-23');
INSERT INTO `customernurseitem` VALUES (74, 12, 40, NULL, 2, 0, '2023-10-23', '2024-01-23');
INSERT INTO `customernurseitem` VALUES (75, 1, 35, 4, 2, 0, '2023-10-24', '2024-01-24');
INSERT INTO `customernurseitem` VALUES (76, 2, 35, 4, 2, 0, '2023-10-24', '2024-01-24');
INSERT INTO `customernurseitem` VALUES (77, 3, 35, 4, 2, 0, '2023-10-24', '2024-01-24');
INSERT INTO `customernurseitem` VALUES (78, 5, 35, 4, 2, 0, '2023-10-24', '2024-01-24');
INSERT INTO `customernurseitem` VALUES (79, 1, 41, 1, 2, 0, '2023-12-03', '2024-02-01');
INSERT INTO `customernurseitem` VALUES (80, 2, 41, 1, 2, 0, '2023-12-03', '2024-03-03');
INSERT INTO `customernurseitem` VALUES (81, 4, 41, 1, 2, 0, '2023-12-03', '2024-03-03');
INSERT INTO `customernurseitem` VALUES (82, 5, 41, 1, 2, 0, '2023-12-03', '2024-03-03');
INSERT INTO `customernurseitem` VALUES (83, 6, 41, 1, 2, 0, '2023-12-03', '2024-03-03');
INSERT INTO `customernurseitem` VALUES (84, 20, 41, NULL, 2, 0, '2023-12-03', '2024-01-05');
INSERT INTO `customernurseitem` VALUES (85, 1, 36, 1, 2, 0, '2023-12-15', '2024-03-15');
INSERT INTO `customernurseitem` VALUES (86, 2, 36, 1, 2, 0, '2023-12-15', '2024-03-15');
INSERT INTO `customernurseitem` VALUES (87, 4, 36, 1, 2, 0, '2023-12-15', '2024-03-15');
INSERT INTO `customernurseitem` VALUES (88, 5, 36, 1, 2, 0, '2023-12-15', '2024-03-15');
INSERT INTO `customernurseitem` VALUES (89, 6, 36, 1, 2, 0, '2023-12-15', '2024-01-17');
INSERT INTO `customernurseitem` VALUES (90, 3, 41, NULL, 2, 0, '2023-12-15', '2024-01-18');
INSERT INTO `customernurseitem` VALUES (91, 5, 40, 2, 2, 0, '2025-06-01', '2025-06-01');
INSERT INTO `customernurseitem` VALUES (92, 1, 42, 4, 1, 0, '2025-06-06', '2025-07-17');
INSERT INTO `customernurseitem` VALUES (93, 2, 42, 4, 1, 0, '2025-06-06', '2025-08-06');
INSERT INTO `customernurseitem` VALUES (94, 3, 42, 4, 2, 0, '2025-06-06', '2025-07-14');
INSERT INTO `customernurseitem` VALUES (95, 5, 42, 4, 2, 0, '2025-06-06', '2025-07-25');
INSERT INTO `customernurseitem` VALUES (96, 6, 42, NULL, 6, 1, '2025-06-07', '2025-08-07');
...
CREATE TABLE `customerpreference`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '喜好ID',
  `customer_id` bigint(0) NULL DEFAULT NULL COMMENT '顾客ID',
...
INSERT INTO `customerpreference` VALUES (4, 41, '多糖', '不建议摄入过多糖分', '尽量少糖', 0);
INSERT INTO `customerpreference` VALUES (14, 42, '冰淇淋', '肥胖', '巧克力口味', 0);
INSERT INTO `customerpreference` VALUES (15, 43, '巧克力', '蛀牙', '少糖', 0);
INSERT INTO `customerpreference` VALUES (16, 38, '口味清淡', '咽炎', '少盐', 0);
...
CREATE TABLE `dietary`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '膳食ID',
  ...
  `create_on` timestamp(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `dietary_calendar`  (
  `id` int(0) NOT NULL COMMENT '膳食日历ID',
  `dietary_id` int(0) NULL DEFAULT NULL COMMENT '膳食编号',
...
-- ----------------------------
-- Table structure for failed_mail_record
-- ----------------------------
DROP TABLE IF EXISTS `failed_mail_record`;
CREATE TABLE `failed_mail_record`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `recipient` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '收件人邮箱',
  ...
  `status` tinyint(0) NULL DEFAULT 0 COMMENT '状态：0-待处理 1-处理中 2-处理成功 3-处理失败',
  `next_retry_time` datetime(0) NULL DEFAULT NULL COMMENT '下次重试时间',
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_status_retry_time`(`status`, `next_retry_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '失败邮件记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of failed_mail_record
-- ----------------------------
...
CREATE TABLE `food`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '食品ID',
  ...
  `price` decimal(10, 2) NULL DEFAULT NULL COMMENT '价格',
  `is_halal` int(0) NULL DEFAULT NULL COMMENT '是否清真',
...
INSERT INTO `food` VALUES (4, '白灼芥兰', '素菜', 5.00, 0, 'arabidopsis.jpg');
...
INSERT INTO `food` VALUES (10, '西红柿鸡蛋汤', '汤', 3.00, 0, 'tomato_egg_soup.jpg');
...
CREATE TABLE `meal`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '饮食ID',
  ...
  `meal_type` int(0) NULL DEFAULT NULL COMMENT '食品类型（1.早餐、2.午餐、3.晚餐）',
...
INSERT INTO `meal` VALUES (93, '周一', 2, 2, '少糖', 0);
...
INSERT INTO `menu` VALUES (32, '1', '支付管理', 'ScaleToOriginal', '/patient/payList', 0);
INSERT INTO `menu` VALUES (33, '7', '统计管理', 'DataLine', '/data/dataList', 0);
...
INSERT INTO `nursecontent` VALUES (17, 'HLXM0017', '剪指甲', '12元/次', '', 1, '每月', '2', 0);
INSERT INTO `nursecontent` VALUES (20, 'HLXM0019', '协助外出', '100元/次', '', 1, '每月', '4', 0);
INSERT INTO `nursecontent` VALUES (21, 'HLXM0020', '瑜伽辅导', '80元/次', '', 2, '每周', '2', 0);
INSERT INTO `nursecontent` VALUES (22, 'HLXM0021', '吃饭', '5元/次', '', 1, '每天', '3', 0);
INSERT INTO `nursecontent` VALUES (23, 'HLXM0022', '上厕所', '免费', '', 1, '每天', '3', 0);
INSERT INTO `nursecontent` VALUES (24, 'HLXM0022', '聊天', '免费', '', 1, '每天', '1', 0);
...
CREATE TABLE `nurselevel`  (
  ...
  `level_status` int(0) NULL DEFAULT NULL COMMENT '级别状态 1：启用；2：停用',
  `is_deleted` int(0) NULL DEFAULT NULL COMMENT '逻辑删除标记（0：显示；1：隐藏）',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `nurselevel` VALUES (5, '五级', 1, NULL);
INSERT INTO `nurselevel` VALUES (6, '六级', 2, NULL);
INSERT INTO `nurselevel` VALUES (7, '七级', 1, NULL);
INSERT INTO `nurselevel` VALUES (8, '八级', 1, NULL);
...
CREATE TABLE `nurselevelitem`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `level_id` int(0) NOT NULL COMMENT '关联护理级别',
  `item_id` int(0) NOT NULL COMMENT '关联护理项目',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `nurselevel_id_fk`(`level_id`) USING BTREE,
  INDEX `nurseItem_id_fk`(`item_id`) USING BTREE
...
INSERT INTO `nurselevelitem` VALUES (93, 5, 1);
...
CREATE TABLE `nurserecord`  (
  ...
  `is_deleted` int(0) NOT NULL COMMENT '逻辑删除标记（0：显示；1：隐藏）',
  `customer_id` bigint(0) NOT NULL COMMENT '客户ID',
  `item_id` int(0) NOT NULL COMMENT '护理项目ID',
  `nursing_time` datetime(0) NOT NULL COMMENT '护理时间',
  `nursing_content` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '护理内容',
  `nursing_count` int(0) NOT NULL COMMENT '护理数量',
  `user_id` bigint(0) NOT NULL COMMENT '护理人员ID',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `nurserecord` VALUES (16, 1, 41, 1, '2024-01-16 00:00:00', '', 1, 2);
INSERT INTO `nurserecord` VALUES (17, 0, 41, 2, '2024-05-20 00:00:00', '协助服药', 1, 2);
INSERT INTO `nurserecord` VALUES (18, 1, 40, 3, '2025-07-04 00:00:00', '协助吃饭', 1, 3);
INSERT INTO `nurserecord` VALUES (19, 0, 42, 5, '2026-02-28 00:00:00', '', 1, 7);
INSERT INTO `nurserecord` VALUES (34, 0, 42, 5, '2026-03-01 12:04:31', '温水洗头', 1, 7);
...
INSERT INTO `outward` VALUES (6, NULL, 0, 39, '回家', '2024-01-15', '2024-01-17', NULL, '儿子', NULL, '13312341234', 1, '1', '2025-07-08');
INSERT INTO `outward` VALUES (7, NULL, 0, 41, '回家探亲', '2024-05-20', '2024-05-22', '2024-05-20', '女儿', NULL, '13312341234', 1, '1', '2024-05-20');
INSERT INTO `outward` VALUES (8, NULL, 0, 40, '吃饭', '2025-06-30', '2025-07-01', '2025-06-30', '女儿', '', '18324275991', 1, '1', NULL);
INSERT INTO `outward` VALUES (9, NULL, 1, 42, '吃饭', '2026-03-01', '2026-03-02', NULL, '无', NULL, '无', 0, '', NULL);
INSERT INTO `outward` VALUES (10, NULL, 1, 42, '学校', '2026-03-02', '2026-03-03', NULL, '无', NULL, '18324275991', 0, '', NULL);
...
INSERT INTO `role` VALUES (3, '2026-02-28 21:37:13.000000', NULL, NULL, 0, '普通用户');
...
CREATE TABLE `rolemenu`  (
  ...
  `menu` int(0) NOT NULL COMMENT '菜单编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `rolemenu` VALUES (9, 3, 32);
INSERT INTO `rolemenu` VALUES (10, 1, 33);
...
CREATE TABLE `user`  (
  ...
  `username` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '系统账号',
  ...
  `role_id` int(0) NOT NULL COMMENT '系统角色编号（1-管理员 2-健康管家）',
  `status` int(0) NOT NULL COMMENT '状态（0：禁用；1：正常）',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '2023-11-02', 0, '2026-03-20', 0, 0, 'admin', 'admin', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, '2855733759@qq.com', '13545453412', 1, 1);
INSERT INTO `user` VALUES (2, '2023-11-03', 0, '2023-11-03', 0, 0, '吴伟', 'wuwei', '$2a$10$mUWgnWpxxJrpfb3DxKCEgOc5VjIUrHnFIkkOglWuZvRaYtLK1Y9ui', 1, 'wuwei@s.cq', '13517178987', 2, 1);
INSERT INTO `user` VALUES (3, '2023-11-21', 0, '2023-11-21', 0, 0, '陈小明', 'chenxiaoming', '$2a$10$aVPxIbngyMWswZIZo3KdkuSXwYDmCWvyOZi2WMdFuhhZl7CE2sDpW', 0, 'chenxiaoming@s.cq', '18767890987', 2, 1);
INSERT INTO `user` VALUES (4, '2023-11-21', 0, '2023-11-21', 0, 0, '张兴', 'zhangxing', '$2a$10$6KlwdB/GNyVl352sYvsrOuJ1V3CjiuPowORJJEgo4luM07rHrKxfe', 1, 'zhangxing@s.cq', '18878675643', 2, 1);
INSERT INTO `user` VALUES (5, '2023-11-21', 0, '2023-11-21', 0, 0, '王年华', 'wangnianhua', '$2a$10$zySqF7qi94FC0XLKpqw8tOWpGirZ/h0af7LociaPcHVykz.ksyCyK', 0, 'wangnianhua@s.cq', '13412128976', 2, 1);
INSERT INTO `user` VALUES (6, '2023-11-21', 0, '2026-03-04', 1, 0, '吴优', 'wuyou', '$2a$10$a9qpstfRriEF69BOgO8.o.eTn2Gq0YlDjvTNeNEXXaYcvPnYh6qni', 1, 'wuyou@s.cq', '13567452789', 2, 1);
INSERT INTO `user` VALUES (7, '2025-07-07', 1, '2026-03-04', 1, 0, '杨依儒', 'mocha', '$2a$10$xRHmqatkx9kRlinl2CPlWubRL6t9kKJR2Ki6vjpAkrnMhKuXqXqrS', 2, '', '18324275991', 2, 1);
INSERT INTO `user` VALUES (8, '2023-11-22', 0, NULL, NULL, 0, '李建国', 'lijanguo', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'lijanguo@s.cq', '13812345678', 2, 1);
INSERT INTO `user` VALUES (9, '2023-11-22', 0, NULL, NULL, 0, '王芳', 'wangfang', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'wangfang@s.cq', '13912345678', 2, 1);
INSERT INTO `user` VALUES (10, '2023-11-23', 0, NULL, NULL, 0, '张伟', 'zhangwei', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'zhangwei@s.cq', '13712345678', 2, 1);
INSERT INTO `user` VALUES (11, '2023-11-23', 0, NULL, NULL, 0, '刘丽', 'liuli', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'liuli@s.cq', '13612345678', 2, 1);
INSERT INTO `user` VALUES (12, '2023-11-24', 0, NULL, NULL, 0, '陈强', 'chenqiang', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'chenqiang@s.cq', '13512345678', 2, 1);
INSERT INTO `user` VALUES (13, '2023-11-24', 0, NULL, NULL, 0, '赵敏', 'zhaomin', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'zhaomin@s.cq', '13412345678', 2, 1);
INSERT INTO `user` VALUES (14, '2023-11-25', 0, NULL, NULL, 0, '孙涛', 'suntao', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'suntao@s.cq', '13312345678', 2, 1);
INSERT INTO `user` VALUES (15, '2023-11-25', 0, NULL, NULL, 0, '周静', 'zhoujing', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'zhoujing@s.cq', '13212345678', 2, 1);
INSERT INTO `user` VALUES (16, '2023-11-26', 0, NULL, NULL, 0, '吴磊', 'wulei', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'wulei@s.cq', '13112345678', 2, 1);
INSERT INTO `user` VALUES (17, '2023-11-26', 0, NULL, NULL, 0, '郑洁', 'zhengjie', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'zhengjie@s.cq', '13012345678', 2, 1);
INSERT INTO `user` VALUES (18, '2023-11-27', 0, NULL, NULL, 0, '王磊', 'wanglei', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'wanglei@s.cq', '15912345678', 2, 1);
INSERT INTO `user` VALUES (19, '2023-11-27', 0, NULL, NULL, 0, '李娜', 'lina', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'lina@s.cq', '15812345678', 2, 1);
INSERT INTO `user` VALUES (20, '2023-11-28', 0, NULL, NULL, 0, '张敏', 'zhangmin', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'zhangmin@s.cq', '15712345678', 2, 1);
INSERT INTO `user` VALUES (21, '2023-11-28', 0, NULL, NULL, 0, '刘强', 'liuqiang', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'liuqiang@s.cq', '15612345678', 2, 1);
INSERT INTO `user` VALUES (22, '2023-11-29', 0, NULL, NULL, 0, '陈静', 'chenjing', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'chenjing@s.cq', '15512345678', 2, 1);
INSERT INTO `user` VALUES (23, '2023-11-29', 0, NULL, NULL, 0, '杨勇', 'yangyong', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'yangyong@s.cq', '15412345678', 2, 1);
INSERT INTO `user` VALUES (24, '2023-11-30', 0, NULL, NULL, 0, '黄娟', 'huangjuan', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'huangjuan@s.cq', '15312345678', 2, 1);
INSERT INTO `user` VALUES (25, '2023-11-30', 0, NULL, NULL, 0, '徐涛', 'xutao', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'xutao@s.cq', '15212345678', 2, 1);
INSERT INTO `user` VALUES (26, '2023-12-01', 0, NULL, NULL, 0, '胡雪', 'huxue', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'huxue@s.cq', '15112345678', 2, 1);
INSERT INTO `user` VALUES (27, '2023-12-01', 0, NULL, NULL, 0, '林峰', 'linfeng', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'linfeng@s.cq', '15012345678', 2, 1);
INSERT INTO `user` VALUES (28, '2023-12-02', 0, NULL, NULL, 0, '郭燕', 'guoyan', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'guoyan@s.cq', '18812345678', 2, 1);
INSERT INTO `user` VALUES (29, '2023-12-02', 0, NULL, NULL, 0, '马超', 'machao', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'machao@s.cq', '18712345678', 2, 1);
INSERT INTO `user` VALUES (30, '2023-12-03', 0, NULL, NULL, 0, '朱琳', 'zhulin', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'zhulin@s.cq', '18612345678', 2, 1);
INSERT INTO `user` VALUES (31, '2023-12-03', 0, NULL, NULL, 0, '秦刚', 'qingang', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'qingang@s.cq', '18512345678', 2, 1);
INSERT INTO `user` VALUES (32, '2023-12-04', 0, NULL, NULL, 0, '顾佳', 'gujia', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'gujia@s.cq', '18412345678', 2, 1);
INSERT INTO `user` VALUES (33, '2023-12-04', 0, NULL, NULL, 0, '沈强', 'shenqiang', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'shenqiang@s.cq', '18312345678', 2, 1);
INSERT INTO `user` VALUES (34, '2023-12-05', 0, NULL, NULL, 0, '韩梅', 'hanmei', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'hanmei@s.cq', '18212345678', 2, 1);
INSERT INTO `user` VALUES (35, '2023-12-05', 0, NULL, NULL, 0, '彭博', 'pengbo', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'pengbo@s.cq', '18112345678', 2, 1);
INSERT INTO `user` VALUES (36, '2023-12-06', 0, NULL, NULL, 0, '陆瑶', 'luyao', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'luyao@s.cq', '18012345678', 2, 1);
INSERT INTO `user` VALUES (37, '2023-12-06', 0, NULL, NULL, 0, '苏晨', 'suchen', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'suchen@s.cq', '17912345678', 2, 1);
INSERT INTO `user` VALUES (38, '2023-12-07', 0, NULL, NULL, 0, '卢慧', 'luhui', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'luhui@s.cq', '17812345678', 2, 1);
INSERT INTO `user` VALUES (39, '2023-12-07', 0, NULL, NULL, 0, '蒋轩', 'jiangxuan', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'jiangxuan@s.cq', '17712345678', 2, 1);
INSERT INTO `user` VALUES (40, '2023-12-08', 0, NULL, NULL, 0, '蔡琴', 'caiqin', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'caiqin@s.cq', '17612345678', 2, 1);
INSERT INTO `user` VALUES (41, '2023-12-08', 0, NULL, NULL, 0, '余峰', 'yufeng', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'yufeng@s.cq', '17512345678', 2, 1);
INSERT INTO `user` VALUES (42, '2023-12-09', 0, NULL, NULL, 0, '杜娟', 'dujuan', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'dujuan@s.cq', '17412345678', 2, 1);
INSERT INTO `user` VALUES (43, '2023-12-09', 0, NULL, NULL, 0, '戴维', 'daiwei', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'daiwei@s.cq', '17312345678', 2, 1);
INSERT INTO `user` VALUES (44, '2023-12-10', 0, NULL, NULL, 0, '魏晨', 'weichen', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'weichen@s.cq', '17212345678', 2, 1);
INSERT INTO `user` VALUES (45, '2023-12-10', 0, NULL, NULL, 0, '谭敏', 'tanmin', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'tanmin@s.cq', '17112345678', 2, 1);
INSERT INTO `user` VALUES (46, '2023-12-11', 0, NULL, NULL, 0, '宋阳', 'songyang', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'songyang@s.cq', '17012345678', 2, 1);
INSERT INTO `user` VALUES (47, '2023-12-11', 0, NULL, NULL, 0, '欧阳雪', 'ouyangxue', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'ouyangxue@s.cq', '16912345678', 2, 1);
INSERT INTO `user` VALUES (48, '2023-12-12', 0, NULL, NULL, 0, '慕容峰', 'murongfeng', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'murongfeng@s.cq', '16812345678', 2, 1);
INSERT INTO `user` VALUES (49, '2023-12-12', 0, NULL, NULL, 0, '诸葛明', 'zhugeming', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 1, 'zhugeming@s.cq', '16712345678', 2, 1);
INSERT INTO `user` VALUES (50, '2023-12-13', 0, NULL, NULL, 0, '司马青', 'simaqing', '$2a$10$7LypE1rnTYTUf8LEQWIyZ.2rck4rPjldAJbp3Erowm3nJ6sNUP1cm', 0, 'simaqing@s.cq', '16612345678', 2, 1);
